...
export default function DietScreen() {
  ...
  const fetchSmartSuggestion = async () => {
    ...
    try {
      ...
      console.log("Failed to fetch suggestion", error);
    } finally {
  ...
  const updateWater = async (newCount: number) => {
    ...
    await AsyncStorage.setItem(STORAGE_KEY_WATER, newCount.toString());
  };
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>Fuel your body to quit smoking</Text>
        </View>
          ...
          {meals.map((meal, index) => (
            <Animated.View key={meal.id} entering={FadeInDown.delay(300 + (index * 50)).duration(400)} style={styles.mealItem}>
              ...
              <View style={styles.mealRight}>
                ...
                <TouchableOpacity onPress={() => handleDeleteMeal(meal.id)} hitSlop={10}>
          ...
          >
            <View style={styles.waterHeader}>
              <View>
                ...
                <Text style={styles.waterSubtitle}>Flush out nicotine & toxins</Text>
              </View>
            ...
            <View style={styles.waterControls}>
              <TouchableOpacity
                onPress={() => waterGlasses > 0 && updateWater(waterGlasses - 1)}
              ...
              <TouchableOpacity
                onPress={() => waterGlasses < 12 && updateWater(waterGlasses + 1)}
            ...
            <View style={styles.glassesContainer}>
              {[...Array(8)].map((_, i) => (
                <View key={i} style={[
                  ...
                  i < waterGlasses ? styles.glassFilled : styles.glassEmpty
                ]} />
              ))}
            </View>
          </LinearGradient>
