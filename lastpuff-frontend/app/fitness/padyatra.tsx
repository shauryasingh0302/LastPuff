...
const MILESTONES = [
    { id: 1, name: 'Sabarmati Ashram', location: 'Ahmedabad', distance: 0, description: 'Journey begins' },
    { id: 2, name: 'Aslali', location: 'Gujarat', distance: 22, description: 'First village' },
    { id: 3, name: 'Bareja', location: 'Gujarat', distance: 40, description: 'Growing support' },
    { id: 4, name: 'Nadiad', location: 'Gujarat', distance: 75, description: 'Thousands join' },
    { id: 5, name: 'Anand', location: 'Gujarat', distance: 95, description: 'The milk city' },
    { id: 6, name: 'Borsad', location: 'Gujarat', distance: 125, description: 'Momentum builds' },
    { id: 7, name: 'Bharuch', location: 'Gujarat', distance: 200, description: 'River crossing' },
    { id: 8, name: 'Surat', location: 'Gujarat', distance: 260, description: 'Diamond city' },
    { id: 9, name: 'Navsari', location: 'Gujarat', distance: 300, description: 'Final stretch' },
    { id: 10, name: 'Dandi', location: 'Gujarat', distance: 385, description: 'Salt Satyagraha! 🇮🇳' },
];
...
export default function PadyatraScreen() {
    ...
    const progressPercentage = Math.min((totalDistance / TOTAL_DISTANCE) * 100, 100);
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <View style={styles.header}>
                    ...
                    {DEMO_MODE && (
                        <Animated.View entering={FadeInDown.delay(300)} style={styles.demoBadge}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
                {DEMO_MODE && (
                    <View style={styles.debugPanel}>
                        ...
                        <Text style={styles.debugText}>
                            {locationEnabled ? '✅ GPS Active - Walk to count steps!' : '❌ GPS not enabled'}
                        </Text>
                        ...
                        <Text style={[styles.debugText, { marginTop: 8, fontSize: 10, fontStyle: 'italic' }]}>
                ...
                >
                    ...
                    <View style={[styles.statCard, { backgroundColor: '#FFF' }]}>
                        ...
                        <Text style={[styles.statValue, { color: '#000' }]}>{caloriesBurnt}</Text>
                ...
                >
                    ...
                    {MILESTONES.map((milestone, index) => {
                        ...
                        const isNext =
                            !isUnlocked && totalDistance >= (MILESTONES[index - 1]?.distance || 0);
